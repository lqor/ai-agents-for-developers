...
Or you can just run the type script directly "npx tsx src/step1.ts"

## API Keys

We'll use openai SDK to make callouts to their LLM. You can use Claude as well. They are all the same in a lot of senses. For this you need to get your API key from the platform and add it into the .env file.
